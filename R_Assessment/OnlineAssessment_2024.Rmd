...
student_view <- 'hide'   # set to 'hide' to not reveal output, 'markup' to show
...
You should have 1071 rows and 18 variables.
...
You have it correct if you find that the population weighted average for `vcrime.pc` in states in which the Republican candidate won in 2021 is 420.8098. 
...
plot1 <- ggplot(dataplot1, aes(x = Year, y = ur, colour = State))   +
            geom_line() +
