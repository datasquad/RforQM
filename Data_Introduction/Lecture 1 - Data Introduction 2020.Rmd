...
\begin{itemize}
  ...
  \item An overview of the mpirical evidence is provided in this report by \href{https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/844350/impacts_of_minimum_wages_review_of_the_international_evidence_Arindrajit_Dube_web.pdf}{Arindrajit Dube for the UK Government}. \\
...
\begin{itemize}
  ...
  \item Introduce the Diff-in-Diff Methodology (Project!!)
...
```{r, echo = TRUE, error = FALSE, message = FALSE, results = FALSE, warning = FALSE}
ck_data<- read_xlsx("CK_public.xlsx")
