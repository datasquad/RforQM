...
The interpretation of coefficient estimates changes as explanatory variables take a more general form. Let's look again at the dataset of all observations coming from the 2008-2010 wave.
...
We now estimate a regression model which includes a constant and the household's monthly income as an explanatory variable ($iNC_I$ OR VARIABLE `x047D` in our dataset).
...
Before we interpret the estimated coefficient values, let us visualise the data.