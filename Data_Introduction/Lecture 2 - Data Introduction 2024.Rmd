...
\[t = \dfrac{\bar{fds}_{2021} - \bar{fds}_{2001}}{\sqrt{\frac{s_{fds,2021}}{n}+\frac{s_{fds,2001}}{n}}}\]
...
\textcolor{student}{Comment that the difference, 54, is about 13% of the 2001 mean.}
...
Two interpretations (noye that here $y$ is the dependent and $x$ the explanatory variable)
