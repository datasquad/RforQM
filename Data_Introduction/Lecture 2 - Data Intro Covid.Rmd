...
* We are tapping directly into the ECDC's datafile. Everytime you do this you will get the most recent data (on 5 Feb 2021 this delivered 10433 observations)
...
Table2 now contains an observation for each country with the average of weekly cases and deaths. Why is there such a stark difference between [Algeria](https://en.wikipedia.org/wiki/Algeria) and [Anguilla](https://en.wikipedia.org/wiki/Anguilla)?
