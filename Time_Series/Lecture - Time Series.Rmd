...
For all these reasons, when considering time-series data, we need to **assume that the data used are stationary. If not estimated coefficients will be, in general, neither unbiased nor consistent**.
