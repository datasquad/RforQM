...
## Our orking example - female unemployment rate
...
Recall that the information set we used to estimate the model is the set of information available to us: $It = {ur_T,ur_{T-1},ur_{T-2},...}$ or in differences  $It = {\Delta ur_T,\Delta ur_{T-1},\Delta ur_{T-2},...}$.
...
The forecasting equation (\ref{AR2f}) requires two more steps before we can use it:
  ...
  * Notice that \\$E[\Delta ur_{T}|I_T] = ur_{T}$ and $E[\Delta ur_{T-1}|I_T] = ur_{T-1}$
