...
-   here observations are from Q1 1955 to Q3 2019 (259 observations)
...
\begin{tabular}{ccc}
    ...
    253 & $y_{2019Q2}$ & $y_{2019Q1}$ \\

    254 & $y_{2019Q3}$ & $y_{2019Q2}$ \\     
    \hline 
\end{tabular}
```
...
-   the ACF shows that the unemployment rate is also very persistant and the ACF only slowly converges to 0. $\Rightarrow$ a series can be oersitant without time trend
