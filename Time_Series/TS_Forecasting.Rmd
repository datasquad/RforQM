...
Any misspecification, in particular with respect to a) will cause forecasts to be off. And impotantly any substantial change in the economy which changes the information in a) or b), but particularly in a), during the forecast period will also ensure that the forecasts from such a model are problematic and otentially significantly off.

It is for this reason that any forecatss produced from such models (and much more complex models) should always be accompanied with this health warning. Just imagine you had produced forecasts for May 2020 unemployment in 2019 .... it should be clear that such forecasts would have been virtually useless due to the emergance of the global Covid-19 crisis.