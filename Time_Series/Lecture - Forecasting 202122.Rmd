...
Nov 2021 & $T-2$ & 4.0  & 0.0 & ~ & ~  \\
Dec 2021 & $T-1$ & 3.9  & -0.1 & ~ & ~  \\
Jan 2022 & $T$ & 3.9  & 0.0  & ~ & ~  \\
Feb 2022 & $T+1$ & ~ & ~  &  -0.0257 & 3.8743 \\
Mar 2022 & $T+2$ & ~ & ~  & -0.0090 & 3.8653 \\
...& ~ & ~ & ~ & ~ & ~ 
\end{tabular}
\end{table}
...
So far we forecast for 2022 and if we wanted to evaluate how well we did we would have to wait for a year to obtain realised values.
