...
In our dataset $t = 1,...,T$ from April 1992 ($t=1$) to Jan 2021 ($t=T$). We want to obtain forecasts for Feb 2021 ($T+1$), Mar 2021 ($T+2$), etc.
...
**Step 1**  
We obtain parameter estimates by estimating this model on all available data ($I_T$) $\Rightarrow \hat{\alpha}, \hat{\beta}_1, \hat{\beta}_2$. We also obtain the sample variance of the residuals ($s^2_u$)
