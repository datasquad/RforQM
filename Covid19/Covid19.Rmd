...
```{r}
sel_countries <- c("Sweden", "Germany", "Brazil")
...
You can clearly see the exponential growth in the number of cases at the beginning of the pandemic. Later you see, depending on teh country, that the implementation of various preventative strategies like travel bans and social distancing, flattened the curve. Sometimes you will see these graphs on a logarithmic scale.
