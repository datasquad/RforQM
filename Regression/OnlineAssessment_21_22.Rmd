...
task_7b <- data_avg %>% 
select(country, avg_road_pp) %>% arrange(desc(avg_road_pp)) %>% print()
task_7c <- data_avg %>% 
select(country, avg_rail_pp) %>% arrange(avg_rail_pp) %>% print()
task_7d <- data_avg %>% 
select(country, avg_road_pp) %>% arrange(avg_road_pp) %>% print()
```
