...
The example is the example discussed in Demonstration CLass 2 and comes from the Doing Economics Project 3.
...
You will find a new file called "Table1.doc" in your working directory. You can then copy that Table into your project file. There you can still manipulate it. For instance change the variable names or add Table notes.

In fact, in Word the Table will look even better if you change the type to to be a html table (using `type_out = "html"`).
